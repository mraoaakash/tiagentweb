...
<video
  ...
  src="assets/videos/sTIL-Quantification.mp4"
  controls
  playsInline
/>
...
<Carousel>
  ...
  <CarouselSlide>
    <figure className="output-sample">
      ...
      />
      <figcaption>Computing the Tumor Associated Stroma (TAS)</figcaption>
    </figure>
  </CarouselSlide>
  <CarouselSlide>
    <figure className="output-sample">
      ...
      />
      <figcaption>Filtering the Lymphocytes in the TAS</figcaption>
    </figure>
  </CarouselSlide>
  <CarouselSlide>
    <figure className="output-sample">
...
<figure className="output-sample">
  <img
    src="assets/images/survival_km_curves.png"
    alt="Kaplan-Meier survival analysis curves for TCGA breast cancer cohort"
  />
</figure>
